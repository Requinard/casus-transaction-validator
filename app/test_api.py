...
from models import TransactionRecord, TransactionCollection, Mutation
...
class MutationTest(TestCase):
    ...
    def test_negative_sign(self):
        ...
        m.validate_transaction(Decimal(1.0), Decimal(0.0))

    def test_positive_sign(self):
        m = Mutation("+1.0")
        m.validate_transaction(Decimal(1.0), Decimal(2.0))
